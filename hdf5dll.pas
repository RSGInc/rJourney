...
const
  ...
  H5_VERS_RELEASE = 19;  (* For tweaks, bug-fixes, or development *)
  H5_VERS_SUBRELEASE = '';  (* For pre-releases like snap0 *)
(* Empty string for real releases.           *)
  H5_VERS_INFO = 'HDF5 library version: 1.8.19';  (* Full version string *)
...
const
  H5D_XFER_DIRECT_CHUNK_READ_FLAG_NAME = 'direct_chunk_read_flag';
...
const
  ...
  H5F_ACC_DEBUG = 0;  (* print debug info (no longer used) *)
...
type
  ...
  H5FD_class_t = record
    ...
    get_eof: function(file_: Pointer {PH5FD_t}): haddr_t; cdecl;
    ...
    lock: function(file_: Pointer {PH5FD_t}; oid: PByte; lock_type: Cardinal; last: hbool_t): herr_t; cdecl;
    unlock: function(file_: Pointer {PH5FD_t}; oid: PByte; last: hbool_t): herr_t; cdecl;
...
type
  ...
  type
    ...
    TH5PLappend = function(plugin_path: PAnsiChar): herr_t; cdecl;
    TH5PLprepend = function(plugin_path: PAnsiChar): herr_t; cdecl;
    TH5PLreplace = function(plugin_path: PAnsiChar; index: Cardinal): herr_t; cdecl;
    TH5PLinsert = function(plugin_path: PAnsiChar; index: Cardinal): herr_t; cdecl;
    TH5PLremove = function(index: Cardinal): herr_t; cdecl;
    TH5PLget = function(index: Cardinal; pathname: PAnsiChar; size: size_t): ssize_t; cdecl;
    TH5PLsize = function(listsize: PCardinal): herr_t; cdecl;
    ...
    TH5Dget_chunk_storage_size = function(dset_id: hid_t; offset: Phsize_t; chunk_bytes: Phsize_t): herr_t; cdecl;
    ...
    TH5Fget_info = function(obj_id: hid_t; bh_info: PH5F_info_t): herr_t; cdecl;
    ...
    TH5FDget_eof = function(file_: PH5FD_t): haddr_t; cdecl;
    ...
    TH5Rdereference = function(dataset: hid_t; ref_type: H5R_type_t; ref: Pointer): hid_t; cdecl;
    ...
    TH5Pget_version = function(plist_id: hid_t; boot: PCardinal; freelist: PCardinal; stab: PCardinal; shhdr: PCardinal): herr_t; cdecl;
  ...
  private
    ...
    FH5PLappend: TH5PLappend;
    FH5PLprepend: TH5PLprepend;
    FH5PLreplace: TH5PLreplace;
    FH5PLinsert: TH5PLinsert;
    FH5PLremove: TH5PLremove;
    FH5PLget: TH5PLget;
    FH5PLsize: TH5PLsize;
    ...
    FH5Dget_chunk_storage_size: TH5Dget_chunk_storage_size;
    ...
    FH5Rdereference: TH5Rdereference;
    ...
    FH5Pget_version: TH5Pget_version;
  ...
  public
    ...
    property H5PLappend: TH5PLappend read FH5PLappend;
    property H5PLprepend: TH5PLprepend read FH5PLprepend;
    property H5PLreplace: TH5PLreplace read FH5PLreplace;
    property H5PLinsert: TH5PLinsert read FH5PLinsert;
    property H5PLremove: TH5PLremove read FH5PLremove;
    property H5PLget: TH5PLget read FH5PLget;
    property H5PLsize: TH5PLsize read FH5PLsize;
    ...
    property H5Dget_chunk_storage_size: TH5Dget_chunk_storage_size read FH5Dget_chunk_storage_size;
    ...
    property H5Fget_info: TH5Fget_info read FH5Fget_info;
    ...
    property H5Rdereference: TH5Rdereference read FH5Rdereference;
    ...
    property H5Pget_version: TH5Pget_version read FH5Pget_version;
...
begin
  ...
  @FH5PLappend := GetDllProc(FHandle, 'H5PLappend');
  @FH5PLprepend := GetDllProc(FHandle, 'H5PLprepend');
  @FH5PLreplace := GetDllProc(FHandle, 'H5PLreplace');
  @FH5PLinsert := GetDllProc(FHandle, 'H5PLinsert');
  @FH5PLremove := GetDllProc(FHandle, 'H5PLremove');
  @FH5PLget := GetDllProc(FHandle, 'H5PLget');
  @FH5PLsize := GetDllProc(FHandle, 'H5PLsize');
  ...
  @FH5Dget_chunk_storage_size := GetDllProc(FHandle, 'H5Dget_chunk_storage_size');
